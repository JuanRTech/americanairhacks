      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <p><h3>Bud Light Beer</h3></p>
            ...
            <a class="portfolio-item d-block mx-auto" href="submitorder.php?id=51">
          ...
          <p><h3>Budweiser Beer</h3></p>
            ...
            <a class="portfolio-item d-block mx-auto" href="submitorder.php?id=52">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                  <p>Request</p>
                </div>
          ...
          <p><h3>Kendall-Jackson Chardonnay Wine</h3></p>
            ...
            <a class="portfolio-item d-block mx-auto" href="submitorder.php?id=53">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                  <p>Request</p>
                </div>
          ...
          <p><h3>Cline Zinfandel Wine</h3></p>
            ...
            <a class="portfolio-item d-block mx-auto" href="submitorder.php?id=54">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                  <p>Request</p>
                </div>
          ...
          <p><h3>Bacardi Rum Spirits</h3></p>
            ...
            <a class="portfolio-item d-block mx-auto" href="submitorder.php?id=55">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                  <p>Request</p>
                </div>
          ...
          <p><h3>Canadian Club Spirits</h3></p>
            ...
            <a class="portfolio-item d-block mx-auto" href="submitorder.php?id=46">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                  <p>Request</p>
                </div>
        ...
        <div class="row">
          ...
          <p><h3>Bud Light Beer</h3></p>
            ...
            <a class="portfolio-item d-block mx-auto" href="submitorder.php?id=51">
              ...
              <img class="img-fluid" src="img/portfolio/budlight.jpg" style="width:400px;height:200px;" alt="">
            </a>
          </div>
          <div class="col-md-6 col-lg-4">
          <center>
          <p><h3>Budweiser Beer</h3></p>
            ...
            <a class="portfolio-item d-block mx-auto" href="submitorder.php?id=52">
              ...
              <img class="img-fluid" src="img/portfolio/budw.jpg" style="width:400px;height:200px;" alt="">
            </a>
          </div>
          <div class="col-md-6 col-lg-4">
          <center>
          <p><h3>Kendall-Jackson Chardonnay Wine</h3></p>
            ...
            <a class="portfolio-item d-block mx-auto" href="submitorder.php?id=53">
              ...
              <img class="img-fluid" src="img/portfolio/kjwine.png" style="width:400px;height:200px;" alt="">
            </a>
          </div>
          <div class="col-md-6 col-lg-4">
          <center>
          <p><h3>Cline Zinfandel Wine</h3></p>
            ...
            <a class="portfolio-item d-block mx-auto" href="submitorder.php?id=54">
              ...
              <img class="img-fluid" src="img/portfolio/czwine.jpg" style="width:400px;height:200px;" alt="">
            </a>
          </div>
          <div class="col-md-6 col-lg-4">
          <center>
          <p><h3>Bacardi Rum Spirits</h3></p>
            ...
            <a class="portfolio-item d-block mx-auto" href="submitorder.php?id=55">
              ...
              <img class="img-fluid" src="img/portfolio/bac.jpg" style="width:400px;height:200px;" alt="">
            </a>
          </div>
          <div class="col-md-6 col-lg-4">
          <center>
          <p><h3>Canadian Club Spirits</h3></p>
            ...
            <a class="portfolio-item d-block mx-auto" href="submitorder.php?id=56">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                  <p>Request</p>
                </div>
              </div>
              <img class="img-fluid" src="img/portfolio/canadian.jpg" style="width:400px;height:200px;" alt="">
            </a>
          </div>
        </div>
      </div>
