...
$.src="https://v2.zopim.com/?5RbZbbJDIOHTpFbNN4BJ34Zw3i7JJTBS";z.t=+new Date;$.
type="text/javascript";e.parentNode.insertBefore($,e)})(document,"script");
  ...
  <body id="page-top">
    ...
    <section class="portfolio" id="portfolio">
      <div class="container">
        <h2 class="text-center text-uppercase text-secondary mb-0">Drinks</h2>
        ...
        <div class="row">
          ...
          <p><h3>Coca-Cola</h3></p>
            ...
            <a class="portfolio-item d-block mx-auto" href="submitorder.php?id=1">
          ...
          <p><h3>Dr.Pepper</h3></p>
            ...
            <a class="portfolio-item d-block mx-auto" href="submitorder.php?id=3">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                  <p>Request</p>
                </div>
              </div>
              <img class="img-fluid" src="img/portfolio/drpepper.jpg" style="width:350px;height:200px;" alt="">
            </a>
          </div>
          <div class="col-md-6 col-lg-4">
          <center>
          <p><h3>Sierra Mist</h3></p>
            ...
            <a class="portfolio-item d-block mx-auto" href="submitorder.php?id=2">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                  <p>Request</p>
                </div>
              </div>
              <img class="img-fluid" src="img/portfolio/sierra.jpg" style="width:350px;height:200px;" alt="">
            </a>
          </div>
          <div class="col-md-6 col-lg-4">
          <center>
          <p><h3>Canada Dry</h3></p>
            ...
            <a class="portfolio-item d-block mx-auto" href="submitorder.php?id=4">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                  <p>Request</p>
                </div>
              </div>
              <img class="img-fluid" src="img/portfolio/canada.jpg" style="width:350px;height:200px;" alt="">
            </a>
          </div>
          <div class="col-md-6 col-lg-4">
          <center>
          <p><h3>Water</h3></p>
            ...
            <a class="portfolio-item d-block mx-auto" href="submitorder.php?id=5">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                  <p>Request</p>
                </div>
              </div>
              <img class="img-fluid" src="img/portfolio/wateriswet.jpg" style="width:350px;height:200px;" alt="">
            </a>
          </div>
          <div class="col-md-6 col-lg-4">
          <center>
          <p><h3>Milk</h3></p>
            ...
            <a class="portfolio-item d-block mx-auto" href="submitorder.php?id=6">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                  <p>Request</p>
                </div>
              </div>
              <img class="img-fluid" src="img/portfolio/milk.jpg" style="width:350px;height:200px;" alt="">
            </a>
          </div>
          <div class="col-md-6 col-lg-4">
          <center>
          <p><h3>Tea</h3></p>
            ...
            <a class="portfolio-item d-block mx-auto" href="submitorder.php?id=7">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                  <p>Request</p>
                </div>
              </div>
              <img class="img-fluid" src="img/portfolio/tea.jpg" style="width:350px;height:200px;" alt="">
            </a>
          </div>
          <div class="col-md-6 col-lg-4">
          <center>
          <p><h3>Minute Maid Apple Juice</h3></p>
            ...
            <a class="portfolio-item d-block mx-auto" href="submitorder.php?id=8">
              <div class="portfolio-item-caption d-flex position-absolute h-100 w-100">
                <div class="portfolio-item-caption-content my-auto w-100 text-center text-white">
                  <p>Request</p>
                </div>
              </div>
              <img class="img-fluid" src="img/portfolio/minute.jpg" style="width:350px;height:200px;" alt="">
            </a>
          </div>
        </div>
      </div>
